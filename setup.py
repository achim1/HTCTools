...
setup(name='HTCTools',
      version=version,
      description='Run any python function on a cluster',
      ...
      url='https://github.com/achim1/HTCTools',
      ...
      keywords=["HTC", "computing", "workflow"],
